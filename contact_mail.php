...
$cmail['to'] = $admin_mail;			// Receiver e-mail address (to which the email will be send)
...
define('GMAIL', 1);
define('GMAIL_USER', $admin_mail);
define('GMAIL_PASS', $admin_mailmdp);
...
if(isset($_POST['anti_spam']) && isset($_POST['anti_spam1']) && $_POST['anti_spam']==$_POST['anti_spam1']) {
  ...
  if(isset($_POST['nume']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message'])) {
    ...
    include('contact/sendmail/class.sendemail.php');

...
{
    $m=0;
    if(preg_match("/\.dmg/", $namefile)){$m = 1;}
    elseif(preg_match("#OSX#i", $namefile)){$m = 1;}
    elseif(preg_match("#dmg#i", $namefile)){$m = 1;}
    elseif(preg_match("i#MacOSX#i", $namefile)){$m=1;}
...
function detectHD($namefile)
{
    ...
    elseif(preg_match("#1080i HDTV#i", $namefile)){$HD = 2;}
	return $HD;
}
...
function defineSection($section)
{
    switch($section)
    {
        ...
        case 'Series':
                ...
                return $table;
        case 'Autre':
        		$table = array("100", "120", "200", "220", "024", "014", "004", "002", "005", "111", "121", "011", "021", "025", "026");
                return $table;
            break;
    }
}
...
function nomfilm ($string) {
    ...
    $string = preg_replace('/web/','', $string);
    $string = preg_replace('/ac3/', '', $string);
    $string = preg_replace('/proper/', '', $string);    
